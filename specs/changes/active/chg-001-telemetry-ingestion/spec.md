---
id: SPEC-CHG-001-TELEMETRY-INGESTION
type: delivery-spec
change-id: CHG-001-TELEMETRY-INGESTION
title: "Especificación de Entrega: Ingesta Telemétrica WSS con mTLS"
version: "1.0.0"
schema-version: "1.0"
...
## 3. Trazabilidad 360° a Suites de Pruebas Ejecutables

| Escenario | Requerimiento PDaC | Archivo de Prueba / Benchmark | Estado |
| :--- | :--- | :--- | :---: |
| Ingesta continua a 10 Hz | `FR-TELEMETRY-STREAM-001` | `tests/features/fr-telemetry-stream-001.feature` | ✅ PASSED |
| Rechazo por salto cinemático | `BR-TELEMETRY-VALIDITY` | `tests/unit/telemetry_gateway.spec.ts` | ✅ PASSED |
| Latencia p99 < 50ms | `QR-LATENCY-REALTIME` | `tests/benchmarks/latency_benchmark.spec.ts` | ✅ PASSED |
| Autenticación mTLS (SEC-TEST-*) | `SEC-REQ-MTLS-STREAM` | `tests/features/security/sec-req-mtls-stream.feature` | ✅ PASSED |
