...
title: "Modular AI-SDLC Pull Request Template"
version: "1.0.0"
schema-version: "1.0"
status: active
description: "Institutional template for monitoring weak points and plan balance (X/O) in SDD deliveries"
---

# Pull Request: [TIER] - [CHANGE-ID] - Brief Title

## 1. SDD Identification and Traceability

- **SDD Change Specification**: `specs/changes/active/<change-id>/`
